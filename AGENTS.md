...
**`rba-decision-service`** (PDP / `/risk/evaluate`), **`rba-idp`** (IdP / PEP),
**`rba-infra`** (shared compose / later Helm), **`rba-ml-training`** (offline data
+ modelling pipeline), and this **`docs`** repo.
